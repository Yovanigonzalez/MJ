...
<div class="main">
        ...
        <div class="containt-produts">
            ...
            <?php while($mostrar = mysqli_fetch_array($resultado)) { ?>
                <div class="card">
                    ...
                    <form class="form" action="modelo/subirBanner.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="container-modal">
        <div class="content-modal">
            ...
            <form action="modelo/subirBanner.php" method="POST" enctype="multipart/form-data">
